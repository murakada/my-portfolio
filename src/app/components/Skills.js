                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[50px]">
                    {expertiseData.map((item,index)=>{
                        return(
                            ...
                            <div className="flex items-center justify-center h-[45px] min-w-[45px] text-amber-500 group-hover:text-white text-center rounded-xl me-5 transition-all duration-500">
                                <div className="">
